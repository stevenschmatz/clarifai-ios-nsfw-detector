    ...
    private func recognizeImage(image: UIImage!) {
        ...
        client.recognizeJpegs([jpeg]) {
            ...
            if error != nil {
                ...
                if imageIsNSFW {
                    self.textView.text = "The image is SFW, with probability \(String(format: "%.2f", 1 - probabilitySFW))!"
                } else {
                self.textView.text = "The image is SFW, with probability \(String(format: "%.2f", probabilitySFW))!"
                }
            }
